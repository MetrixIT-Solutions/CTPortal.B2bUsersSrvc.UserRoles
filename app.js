...
// process.env.PORT = '3403'; // dev

process.env.NODE_ENV = 'prod'; // prod
process.env.PORT = '3303'; // prod
...
app.use((err, req, res, next) => {
  ...
  res.setHeader('Access-Control-Allow-Headers', 'X-Requested-With, content-type, ctpb2batoken, ctpb2botoken, ctpb2bua');
  
  // Response headers you wish to Expose
  res.setHeader('Access-Control-Expose-Headers', 'X-Requested-With, content-type, ctpb2batoken, ctpb2botoken');
